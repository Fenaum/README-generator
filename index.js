...
const questions = [
  ...
  },
  {
    ...
    message:
      "Would you like to allow other developers to contribute on your project?",
    default: true,
  },
  {
    type: "input",
  ...
  },
  {
    ...
    name: "test",
    message:
      "Please provide instructions on how to test the application. (Required)",
    validate: (testInput) => {
      if (testInput) {
        return true;
      } else {
...
function writeToFile(fileContent) {
      return new Promise((resolve, reject) => {
        fs.writeFile("./test-files/sample-README.md", fileContent, (err) => {
          if (err) {
            reject(err);
            return;
          }
